...
mycursor.execute("CREATE TABLE seller_details(seller_id int auto_increment, name varchar(50), phone varchar(20), email varchar(100), address varchar(200), primary key (seller_id));")
